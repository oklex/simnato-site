...
export const Navigation = ({ sticky }: { sticky?: boolean }): ReactElement => {
  ...
  const deferredOpenNav = useDeferredValue(openNav);
  ...
  const showNav = () => (
    <>
      ...
      <FullScreenModal isOpen={deferredOpenNav} onClose={toggleModal}>
